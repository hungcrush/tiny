...
// Filesystem
$moxieManagerConfig['filesystem.rootpath'] ='../../public';  ///webroot/uploads';
...
// Createdir
$moxieManagerConfig['createdir.templates'] = 'Image folder=../../public/';
...
// Local filesystem
$moxieManagerConfig['filesystem.local.wwwroot'] = 'E:/xampp/htdocs/';
$moxieManagerConfig['filesystem.local.urlprefix'] = '{proto}://{host}/';
$moxieManagerConfig['filesystem.local.urlsuffix'] = '?suffix';
